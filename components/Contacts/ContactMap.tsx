...
const ContactMap = () => {
  return (
    <div className={styles.mapContainer}>
      ...
      <p>
        <strong>FREE PARKING from 16:00 to 22:00</strong>
      </p>
      ...
      <div>
        ...
        <p>
          <strong>FREE PARKING IN CUP SHOPPING CENTER</strong>
        </p>
        <div className={styles.mapWrapper}>
          <iframe
            src="https://www.google.com/maps?q=Konstitucijos%20pr.%2012,%20Vilnius,%2009308,%20Lithuania&output=embed"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
